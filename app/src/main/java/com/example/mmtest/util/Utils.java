package com.example.mmtest.util;
...
public abstract class Utils {
	...
	public static final int COLOR_BLUE = Color.parseColor("#d4d4d4");
	public static final int COLOR_VIOLET = Color.parseColor("#db7817");
	public static final int COLOR_GREEN = Color.parseColor("#ffcc75");
	public static final int COLOR_ORANGE = Color.parseColor("#52dfec");
	public static final int COLOR_RED = Color.parseColor("#81e69f");
	public static final int COLOR_LNNE = Color.parseColor("#fdae26");
	...
	public static final int pickPieColor(int i) {
		return COLORS[i];
	}
